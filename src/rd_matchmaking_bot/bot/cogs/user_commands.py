...
class UserCommands(commands.Cog):
    ...
    async def out_of_lobby_roll(self, ctx,
        ...
        level_chosen = levels.roll_random_level(peer_reviewed, played_before, difficulty, players_id_list, self.bot.users_rdsaves)
    ...
    async def leaderboard(self, ctx,
        ...
        users_places = misc.rank_players(unsorted_scores)
